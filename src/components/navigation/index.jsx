...
const Navigation = () => {
  ...
  const filteredBtnList = isHomePage 
    ? BtnList.filter(btn => btn.icon !== "home")
    : BtnList;
        ...
        {({ size }) => {
          return size && size >= 480 ? (
            ...
            <>
              ...
              >
                {filteredBtnList.slice(0, filteredBtnList.length / 2).map((btn) => {
              ...
              >
                {filteredBtnList.slice(filteredBtnList.length / 2, filteredBtnList.length).map(
                  (btn) => {
                    return (
                      <NavButton
                        key={btn.label}
